...
docker build -t trzl/portfolio:shutterbug-react.1 -f ./services/react-nginx/build.Dockerfile ./services/react-nginx && \
# docker push trzl/portfolio:shutterbug-react.1 && \
docker-compose down && \
docker system prune --volumes && \
